...
<?php
    $sql = "SELECT * FROM incentive_table ORDER BY TIMESTAMP DESC";
    if ($result=mysqli_query($conn,$sql))
    {
      // Fetch one and one row
      echo "<TABLE id='incentive-logs_table'>";
      echo "<TR><TH>Card No.</TH><TH>Daily Incentive</TH><TH>Weekly Incentive</TH><TH>Total Incentive</TH><TH>Time Stamp</TH></TR>";
